...
from obscura_config import TOR_SOCKS_PORT, TOR_CONTROL_PORT
...
def scrape_single(url_data, rotate=False, rotate_interval=5, control_port=TOR_CONTROL_PORT, control_password=None):
    """
